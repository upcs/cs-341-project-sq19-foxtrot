...
test('add day function works with adding one',()=>{
  expect(addDays('2019-03-25T07:00:00.000Z', 1).toBe(new Date('2019-03-26T07:00:00.000Z')));
});

test('add day function works with end of month',()=>{
  expect(addDays('2019-03-30T07:00:00.000Z', 3).toBe(new Date('2019-04-02T07:00:00.000Z')));
});

test('Get week number works with valid date',()=>{
  expect(getWeekNumber('2019-03-25T07:00:00.000Z').toBe(13));
});
